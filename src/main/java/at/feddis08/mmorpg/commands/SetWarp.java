    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (label.equalsIgnoreCase("setwarp")) {
            ...
            if (Objects.equals(dbPlayer.didStartup, "true")) {
                    if (args.length == 5) {
                        try {
                            if (Rank.isPlayer_allowedTo(dbPlayer.id, "doSetWarp") || Rank.isPlayer_allowedTo(dbPlayer.id, "*")) {
                                ...
                                if (Objects.equals(dbWarpObject.id, args[0])){
                                    ...
                                    MMORPG.consoleLog("updated warp: " + dbWarpObject.id + " for " + dbPlayer.display_name + "!");
                                    ...
                                    MMORPG.consoleLog("Created warp: " + dbWarpObject.id + " for " + dbPlayer.display_name + "!");
