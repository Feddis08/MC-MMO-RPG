    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (label.equalsIgnoreCase("setportaltrack")) {
            ...
            if (Objects.equals(dbPlayer.didStartup, "true")) {
                    if (args.length == 12) {
                        try {
                            if (Rank.isPlayer_allowedTo(dbPlayer.id, "doSetPortalTrack") || Rank.isPlayer_allowedTo(dbPlayer.id, "*")) {
                                ...
                                if (Objects.equals(dbPortalTrackObject.id, args[0])){
                                    ...
                                    MMORPG.consoleLog("updated portal_track: " + dbPortalTrackObject.id + " for " + dbPlayer.display_name + "!");
                                    ...
                                    MMORPG.consoleLog("Created portal_track: " + dbPortalTrackObject.id + " for " + dbPlayer.display_name + "!");
