...
import at.feddis08.tools.io.database.objects.PlayerInWorlds;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (label.equalsIgnoreCase("tpWorld")) {
            ...
            if (Objects.equals(dbPlayer.didStartup, "true")) {
                try {
                    if (Rank_api.isPlayer_allowedTo(dbPlayer.id, "doTpWorld") || Rank_api.isPlayer_allowedTo(dbPlayer.id, "*")) {
                        if (args.length == 1) {
