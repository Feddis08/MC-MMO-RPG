package at.feddis08.tools.remote_interface.server;

import at.feddis08.Boot;
import at.feddis08.tools.remote_interface.server.main.GameLoop;
...
public class Start {
    ...
    public static void main() throws IOException, InterruptedException {
        Boot.debugLog("Starting the remoteInterface server...");
        Server.th.start();
