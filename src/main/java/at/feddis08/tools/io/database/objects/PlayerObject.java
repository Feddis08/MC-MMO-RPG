...
import at.feddis08.tools.io.database.Object_Manager;
import at.feddis08.bukkit.minecraft.listeners.onChat;
...
// Send the packet object to every online player on the server
    ...
    public void send_chat_message(String message) throws SQLException, IOException {
        ...
        at.feddis08.tools.discord.dcFunctions.send_message_in_channel(DISCORD.config.read_only_chat, "[" +  dbRank.prefix +  "][" + display_name + "]" + ": "
                + message + " [" + Methods.getTime() + "]");
        at.feddis08.tools.discord.dcFunctions.send_message_in_channel(DISCORD.config.chat, "[" +  dbRank.prefix +  "][" + display_name + "]" + ": "
                + message + " [" + Methods.getTime() + "]");
